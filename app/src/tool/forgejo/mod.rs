...
impl Seat {
    ...
    fn work(&self, deed: &Deed) -> Result<Value> {
        match deed {
            ...
            Deed::Status(Kind::Show(id)) => self.standing(id),
            Deed::Status(Kind::Set(id)) => self.marked(id),
            ...
            Deed::Secret(owner, Kind::List) => self.secrets(owner.as_deref()),
            Deed::Secret(owner, Kind::Set(id)) => self.stored(owner.as_deref(), id),
            Deed::Secret(owner, Kind::Drop(id)) => self.cleared(owner.as_deref(), id),
